...
public class Main {
    ...
    static void printWord(Word word, String keyWord) {
        System.out.println("Kata '" + keyWord + "' Ditemukan");
    ...
    public static void main(String[] args) {
        ...
        search.addSeed(new Word("belajar", "learn"));
        search.addSeed(new Word("mimpi", "dream"));
        search.addSeed(new Word("latihan", "practice"));
        search.addSeed(new Word("kejar", "chase"));
        search.addSeed(new Word("pelajaran", "lesson"));
        search.addSeed(new Word("soal", "question"));
        ...
        if(customSearch1 != null) {
            ...
            System.out.println("Kata '"+ keyWord1 +"' Tidak Ditemukan");
        }
        ...
        if(customSearch2 != null) {
            ...
            System.out.println("Kata '"+ keyWord2 +"' Tidak Ditemukan");
        }
        ...
        if(customSearch3 != null) {
            ...
            System.out.println("Kata '"+ keyWord3 +"' Tidak Ditemukan");
        }
